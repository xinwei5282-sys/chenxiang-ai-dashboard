...
顶部四项指标；左侧AI能力、实时预警样例和品牌故事；中央六环节与沉香树球；右侧数字人插画和产品TOP3；底部四项展示内容。所有主内容同时可见，无路由切换。中心组合图与山林底图是参考生成的独立素材；10个图标以原稿图集独立定位；数字人复用原稿插画区域。标题、指标、六节点文字、左右列表和底部入口为HTML。产品缩略图为参考生成素材。Bootstrap Icons以本地SVG文件使用。
